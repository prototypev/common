...
namespace Xyun.Xylona.Common.Extensions
{
    ...
    public static class DateTimeExtensions
    {
        ...
        /// <param name="asAtDate">As at date.</param>
        /// <returns>The number of anniversaries between two dates.</returns>
        ...
        /// <param name="dayOfWeek">The day of week to shift to.</param>
